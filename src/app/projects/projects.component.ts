...
export class ProjectsComponent implements OnInit {
  ...
  PROJECTS_DATA: Project[] = [
    {title: 'Azure DevOps Bicep Tasks',
    link: 'https://github.com/piraces/azure-devops-bicep-task/',
      subtitle: 'Azure DevOps set of tasks that allow to install and run Microsoft Bicep CLI commands',
      imagePath: '/assets/img/development_placeholder.png',
      description: 'This is a simple yet useful Azure DevOps set of tasks that allow to install and run Microsoft Bicep CLI commands in Azure Pipelines (cross-platform).'},
    {title: 'dotnet-tool-run',
    link: 'https://github.com/piraces/dotnet-tool-run',
      subtitle: '.NET tool to execute other dotnet tools without installing them globally or in a project',
      imagePath: '/assets/img/development_placeholder.png',
      description: 'A simple .NET tool to execute other dotnet tools without installing them globally or in a project (a similar approach to npx from npm).'},
    {title: 'guid-ts',
    link: 'https://github.com/piraces/guid-ts',
      subtitle: 'Package for generating and managing globally unique identifiers (GUIDs) v4 in Typescript',
      imagePath: '/assets/img/development_placeholder.png',
      description: 'Lightweight, simple, dependency free, and reliable package. Can parse and generate a GUID based on the RFC4122.'},
    {title: 'kube-score check',
    link: 'https://github.com/marketplace/actions/kube-score-check',
      subtitle: 'Performing static code analysis of your Kubernetes object definitions with a Github Action',
      imagePath: '/assets/img/development_placeholder.png',
      description: 'GitHub Action that executes kube-score with selected manifests (with support for YAML, Helm or Kustomize manifests).'},
    {title: 'developer.li',
    link: 'https://developer.li',
      subtitle: 'Subdomains for free using the domain developer.li (built in Angular)',
      imagePath: '/assets/img/developerli.png',
      description: 'Simple subdomain availability check web which helps you to configure a free subdomain in the developer.li domain (made with the NES.css awesome style).'},
    ...
    {title: 'Fiestas de Ejea',
      link: 'https://github.com/piraces/fiestasEjea',
      subtitle: 'Ionic (Angular), Firebase with CI/CD (bitrise.io)',
      imagePath: '/assets/img/fiestas.png',
      description: 'Festivities info app for my native region, incuding firebase integration. Developed with Ionic (angular). Available for Android and iOS.'},
    ...
    {title: '© - graph',
      link: 'https://github.com/ismaro3/c-graph',
      subtitle: 'Javascript, HTML5, CSS3, SPARQL, Java Spark, Vis.js.',
      imagePath: '/assets/img/c-graph.png',
      description: 'Tools related to the visualisation of copyright evidence and/or enhance the Copyright Wiki (copyrightevidence.org).'},
